...
PATH = 'C:\\bee-vision\\source\\real-sense\\cuda-hmd\\charuco-calib-triple\\capture\\captures-hmd4\\'
CAM1_MASK = 'cam_rs_left*.png'
CAM2_MASK = 'cam_right*.png'
RESULT_PREF = 'rsleft_right'
RES_X = 1280
RES_Y = 720
...
for i in range(0,len(cam1_images),1):
    ...
    #  if (response1 + response2 > 20 and response1 == response2)
    if (response1 + response2 > 20 and response1 == 35  and response2 == 35):  #original 30
...
#Clean images with incomplete number of points 
# temp_corners1 = []
# temp_corners2 = []
# while temp_corners1:
#     x = temp_corners1.pop()
#     if len(CHARUCO_BOARD.chessboardCorners) == len(x):
#         temp_corners1.append(x)
# while temp_corners1:
#     corners1_all.append(temp_corners1.pop())
