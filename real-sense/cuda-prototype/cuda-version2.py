...
#TODO list
# fix the double images in the rectification
# fix or cut the rectification warp of the final images. 
# optimize gpumat declarations and uploads 
# check if the camera taking photos creates a bottle neck
...
try:
    while True:
        ...
        ############### GET DISPARITY GPU for UV CAMERA ########################################### This step takes 4ms
        ...
        ############### Rectify the UV, RGB and Mask images ########################################### Both rectify and remap sections take around 17ms
