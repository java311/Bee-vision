...
def getDisparityMaps(depthMap):
    ...
    dispMapY = grid[0].astype(np.float32) + dispMapY + 9.0
...
try:
    while True:
        ...
        # rec_uv_fcolor =  fakeColor(rec_uv_tmp, rec_color_image)
        # cv2.imshow('debugo', rec_uv_fcolor)
