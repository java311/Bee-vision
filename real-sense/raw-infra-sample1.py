...
config = rs.config()
# config.enable_stream(rs.stream.infrared, 1, 640, 480, rs.format.y8, 30)  #original
# config.enable_stream(rs.stream.infrared, 2, 640, 480, rs.format.y8, 30)  #original
config.enable_stream(rs.stream.infrared, 1, 1920, 1080, rs.format.y16, 15)  #from intel pdf manual 
config.enable_stream(rs.stream.infrared, 2, 1920, 1080, rs.format.y16, 15)  #from intel pdf manual
